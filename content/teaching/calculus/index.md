---
title: Calculus
summary: Calculus teaching materials
...
### Math 7B (Winter 2026), Calculus II for the Life Sciences

 - {{< icon name="download" pack="fas" >}} {{< staticref "uploads/teaching/ucr/math7b/math7b_lecture_notes_winter2026.zip" "newtab" >}}Lecture notes (handwritten){{< /staticref >}}

<h2 style="font-size: 1.6rem; font-weight: 700; margin-top: 2rem;">University of Waterloo</h2>

### Math 127 (Fall 2018), Calculus I for the Sciences
...
### Math 117 (Fall 2016), Calculus I for Engineering
